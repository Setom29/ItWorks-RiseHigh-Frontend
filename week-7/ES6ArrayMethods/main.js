...
const ex5 = () => users.every(user => user.address.city === "South Christy")
// console.log(ex5())

// Find the user who’s suite is “Apt. 950” - console log her company’s name.
const ex6 = () => users.find(user => user.address.suite === "Apt. 950").company.name
// console.log(ex6())

// Write a named function that receives a single parameter, user.
const printUserInfo = user => console.log(`${user.name} lives in ${user.address.city}, and owns the company ${user.company.name}`)
